...
const TRANSLATIONS = Object.freeze({
  zh: Object.freeze({
    ...
    panel: Object.freeze({
      ...
      chatMatch: ({ messageIndex, key }) => [
        `第 ${messageIndex} 楼命中 `,
        { type: 'value', text: key },
      ],
      recursion: '递归触发',
      recursionSingleSource: ({ name, key }) => [
        '递归触发 条目 ',
      ...
      delayedChatMatch: ({ messageIndex, key }) => [
        `延迟到递归轮 第 ${messageIndex} 楼命中 `,
        { type: 'value', text: key },
      ],
      delayedNonChatMatch: ({ sourceType, key }) => [
        `延迟到递归轮 非聊天来源：${sourceType} 命中 `,
        { type: 'value', text: key },
      ],
  ...
  en: Object.freeze({
    ...
    panel: Object.freeze({
      ...
      chatMatch: ({ messageIndex, key }) => [
        `Matched `,
        { type: 'value', text: key },
        ` in message ${messageIndex}`,
      ],
      recursion: 'Triggered by recursion',
      recursionSingleSource: ({ name, key }) => [
        'Triggered by recursion: entry ',
        { type: 'value', text: name },
        '\nKeyword ',
        { type: 'value', text: key },
      ],
      ...
      delayedChatMatch: ({ messageIndex, key }) => [
        `Delayed until recursion; matched `,
        { type: 'value', text: key },
        ` in message ${messageIndex}`,
      ],
      delayedNonChatMatch: ({ sourceType, key }) => [
